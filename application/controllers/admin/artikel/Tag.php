...
class Tag extends Render_Controller
{

    public function index()
    {
        // Page Settings
        $this->title = 'Tag Produk';
        $this->navigation = ['Tag'];
        ...
        $this->breadcrumb_4 = 'Tag';
        $this->breadcrumb_4_url = base_url() . 'artikel/tag';
        // content
        $this->content      = 'admin/artikel/tag';
    ...
    function __construct()
    {
        ...
        $this->photo_path = './files/artikel/tag/';
        $this->load->model("admin/artikel/TagModel", 'model');
