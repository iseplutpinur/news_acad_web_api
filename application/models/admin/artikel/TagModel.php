...
class TagModel extends Render_Model
{
    public function getAllData($draw = null, $show = null, $start = null, $cari = null, $order = null)
    {
        ...
        ( select count(*) from artikel_tag_detail z where z.artikel_tag_id = a.id ) as tag_artikel
        ");
        $this->db->from("artikel_tag a");
    ...
    public function insert($user_id, $nama, $slug, $foto, $keterangan, $status)
    {
        ...
        // Insert users
        $execute = $this->db->insert('artikel_tag', $data);
    ...
    public function update($id, $user_id, $nama, $slug, $foto, $keterangan, $status)
    {
        ...
        $execute = $this->db->update('artikel_tag', $data);
        return  $execute;
    }
    ...
    {
        // Delete users
        $exe = $this->db->where('id', $id)->delete('artikel_tag');
        return $exe;
    }
